...
public class Robot extends TimedRobot {
  ...
  private double encoderConstant = Math.PI * 0.1524 / 2048; //0.152400 meters is 6 inches
  ...
  public WPI_TalonSRX setupWPI_TalonSRX(int port, Sides side, boolean inverted) {
    ...
    switch (side) {
      ...
      case RIGHT:
        ...
        encoder = new Encoder(1, 2, true, CounterBase.EncodingType.k1X);
        encoder.setDistancePerPulse(encoderConstant);
        encoder.setSamplesToAverage(30);
        rightEncoderPosition = encoder::getDistance;
        rightEncoderRate = encoder::getRate;

        break;
      case LEFT:
        encoder = new Encoder(7, 8, false, CounterBase.EncodingType.k1X);
        encoder.setDistancePerPulse(encoderConstant);
        encoder.setSamplesToAverage(30);
